...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
            ...
            <div class="">
            <a href="Controlador?accion=add_carrera" class="btn btn-primary ">Agregar nueva carrera</a>
            </div>
            ...
            <tr class="gradeX">
                <td><%= car.getIdCarrera()%></td>
                        ...
                        <td>                            
                            <a class="btn btn-info btn-xs" href="Controlador?accion=verMaterias&idC=<%= car.getIdCarrera()%>">Ver info</a>
