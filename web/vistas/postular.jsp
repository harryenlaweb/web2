...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <main>
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <form action="../Controlador" enctype="multipart/form-data" method="post">
                            <table align="center">
                                <th colspan="2"><h3 class="text-center">Postularme</h3></th> 

                                 <tr>
                                     <td>Subir mi CV<br /></td> <td><input  class="form-control" type="file" name="file"></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input type="hidden" name="accion" value="subirCV" />

                                        <input type="hidden" name="idVac" value="<%=request.getParameter("idV") %>" />
                                        <input type="hidden" name="idUsuario" value="<%=request.getParameter("idU") %>" />
                                        <input  class="btn btn-block boton1"  type="submit" name="env" value="enviar"></td>
                                </tr>
                            </table>    
                        </form>
        ...
        <div align="center">
             <a class="btn btn-default boton1" href="../Controlador?accion=verVacantes">Volver</a>
        </div>
      <p></p> 
